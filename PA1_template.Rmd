...
The maximum average number os steps is `r maxAvgSteps ` and the interval is `r maxAvgStepsInterval `  
...
Mean: `r TSMean `  
Mean without NA values: `r TSFillMean `  
Median Filled: `r TSMedian `  
Median without NA values: `r TSFillMedian `  
